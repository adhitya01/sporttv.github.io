...
$(".btn_delete_a").click(function(e){
      ...
      if(_ids!=''){
        Swal.fire({
          title: 'Are you sure?',
          input: 'checkbox',
          inputPlaceholder: 'Are you sure you want to delete this banner?'
          ...
          if (result.value) {
            $.ajax({
              ...
              url:'processData.php',
              dataType:'json',
              data:{id:_ids,'action':'multi_delete','yes_no':"yes",'tbl_nm':'tbl_banner'},
              success:function(res){
                  console.log(res);
                  if(res.status=='1'){
            ...
            $.ajax({
              ...
              url:'processData.php',
              dataType:'json',
              data:{id:_ids,'action':'multi_delete','yes_no':"no",'tbl_nm':'tbl_banner'},
              success:function(res){
                  console.log(res);
                  if(res.status=='1'){
                    Swal.fire({type: 'success', text: 'Deleted successfully..!!'}).then(function(){ 
